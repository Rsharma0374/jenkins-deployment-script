...
echo "=== Starting ${APP_NAME:-resume-service} Deployment (Build on Jenkins, Run on Server) ==="

PASSWORD="${1:-}"
BRANCH="${2:-}"

SERVER_IP="152.67.23.79"
REMOTE_USER="opc"

REPO_URL="git@github.com:Rsharma0374/resume-tailor.git"
REPO_NAME="resume-tailor"

APP_NAME="resume-service"
APP_PORT="10009"
